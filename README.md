...
完整方法与原始口径见[感知测试说明](docs/perception-input-testing.md)和
[性能基线文档](docs/perception-resource-profiling.md)。
...
- 性能与内存基线：[`docs/perception-resource-profiling.md`](docs/perception-resource-profiling.md)
- **分步实施细节：**
